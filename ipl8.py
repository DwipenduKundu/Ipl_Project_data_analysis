...
def start8(deliveryfile_path, matchfile_path):
...
def execute8():
    matchfile_path = '/home/dwipendu/Desktop/Ipl_Project_data_analysis-main/data/matches.csv'
    deliveryfile_path = '/home/dwipendu/Desktop/Ipl_Project_data_analysis-main/data/deliveries.csv'
    top_names, top_economy = start8(deliveryfile_path, matchfile_path)
